 ...
 */ !(function (e) {
    ...
    function (e, t, i) {
        ...
        })("versions", []).push({ version: "3.0.0", mode: i(42) ? "pure" : "global", copyright: "Ã‚Â© 2019 Denis Pushkarev (zloirock.ru)" });
    },
    function (e, t, i) {
        var n = i(2);
        e.exports = function (e) {
    ...
    function (e, t, i) {
        ...
        (window.CI360 = window.CI360 || {}),
            (window.CI360.init = r),
            (window.CI360.destroy = function (v_id) {
                console.log(v_id);

                if (v_id) {
                    let des_viewer = '';
                    a() ||
                        (window.CI360._viewers.forEach(function (e, i) {
                            console.log(e.id);
                            if (e.id && v_id == e.id) {
                                des_viewer = i;
                                e.destroy();
                            ...
                            (window.CI360._viewers.splice(des_viewer, 1)));
                } else {
                    a() ||
            ...
            return (
                n(e, [
                    ...
                    },
                    {
                        key: "onMove",
                        value: function (e) {
                            /*  Floor plan Page fixes */
                            var model_id = this.id;
                            if (model_id == 'rotatinImg') {

                                if ($('.floor-plan-page').length) {
                                    jQuery('.floor_mask').hide();
                                }
                            }
                    ...
                    {
                        key: "rotateImgTodegree",
                        value: function (ele) {
                            if ($('.floor-plan-page').length) {
                                jQuery('.floor_mask').hide();
                            }
                            var count = 0;
                            var currentIndex = $('.rotateMyImage').attr('data-cindex');
                            var jumpIndex = ele - currentIndex;

                            if (jumpIndex == 0) {
                                ele = $('.rotateMyImage').data('dindex');
                                jumpIndex = ele - currentIndex;
                            }
                            ...
                            if (jumpIndex > 0) {
                                let mytimer = setInterval(() => {
                                    ...
                                    if (this.activeImage == ele) {
                                        if (jQuery(".rotate-trigger").length) {
                                            jQuery(".rotate-trigger").removeClass('inactive');
                                            //$('.rotate-img').css('pointer-events', 'auto');
                                        }
                                        $('.rotateMyImage').prop('disabled', false);
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var model_id = this.id;
                            if (model_id == 'rotatinImg') {
                                $('.rotateMyImage').attr('data-cindex', this.activeImage);
                                /*  Floor plan Page fixes */
                                if ($('.floor-plan-page').length) {
                                    const rotateTriggerIndex = $('.rotateMyImage').attr('data-index');
                                    if (this.activeImage == rotateTriggerIndex) {
                                        jQuery('.floor_mask').show();
                                        jQuery(".rotate-trigger").removeClass('inactive');
                                        jQuery("#floorp-accordion, .floor-rotate-btn").removeClass('inactive');
                                    }
                                }
                            }
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = document.createElement("div");
                            e.classList = 'loader-process-360';
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var myBtn = document.getElementById('btnRoate');
                            if (i || n) {
                                var s = function (t) {
                                    ...
                                    myBtnPrev = function (t) {
                                        var imgIndex = $(myBtn).attr('data-index');
                                        t.stopPropagation(), e.onSpin(), e.rotateImgTodegree(imgIndex);
                                    },
                                    myBtnNext = function (t) {
                                        var imgIndex = $(myBtn).attr('data-index');
                                        t.stopPropagation(), e.onSpin(), e.rotateImgTodegree(imgIndex);
                                    },
                                    myBtnPrevCT = function () {
                                        e.onFinishSpin(), window.clearTimeout(e.loopTimeoutId);
                                    },
                                    myBtnNextCT = function () {
                                        e.onFinishSpin(), window.clearTimeout(e.loopTimeoutId);
                                    };
                                i &&
                                    ...
                                    myBtn &&
                                    (
                                        myBtn.addEventListener("click", t ? myBtnPrev : myBtnNext),
                                        //myBtn.addEventListener("mousedown", t ? myBtnPrev : myBtnNext),
                                        myBtn.addEventListener("touchstart", t ? myBtnPrev : myBtnNext),
                                        myBtn.addEventListener("mouseup", t ? myBtnPrevCT : myBtnNextCT),
                                        myBtn.addEventListener("touchend", t ? myBtnPrevCT : myBtnNextCT),
                                        (this.nextElem = myBtn)),
    ...
    function (e, t, i) {
        ...
        (t.get360ViewProps = function (e) {
            return {
                ...
                draggable: true,//!o(e, "stop-draggable") || !o(e, "data-stop-draggable"),
            };
        }),
            ...
            (t.setView360Icon = function (e) {
                ...
                if ($('.loader-process-360').parents('.rotate-img').length) {
                    e.style.background = "";
                } else {
                    e.style.background = "rgba(255,255,255,0.8) url('/assets/images/icon_360.svg') 50% 50% / contain no-repeat";
                }
